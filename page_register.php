                                ...
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <form id="js-login" novalidate="" action="register.php" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="email" id="emailverify" class="form-control" placeholder="Эл. адрес" name="user_email" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" id="userpassword" class="form-control" placeholder="" name="user_password" required>
                                            <div class="invalid-feedback">Заполните поле.</div>
                                        </div>
